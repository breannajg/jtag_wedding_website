    ...
    <>
      ...
      <nav className="fixed top-0 left-0 w-full z-50 flex justify-end px-6 py-4 bg-white/30 backdrop-blur-md">
        <ul className="flex gap-6 font-dm text-sm md:text-base font-normal text-neutral-800 tracking-wide antialiased">
          <li><a href="#home" className="hover:text-neutral-500 transition">{getText('navHome')}</a></li>
          <li><a href="#love-story" className="hover:text-neutral-500 transition">{getText('navStory')}</a></li>
          <li><a href="#rsvp" className="hover:text-neutral-500 transition">{getText('navRSVP')}</a></li>
        </ul>
      </nav>
